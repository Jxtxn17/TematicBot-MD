...
if (msg) return conn.reply(m.chat, msg, m, { contextInfo:{ externalAdReply: {title: '📖'  + saludo + 'fake' + nombre, body: dev, sourceUrl: global.channel, thumbnailUrl: ImgAll.getRandom() }}})
