...
if (msg) return conn.reply(m.chat, msg, m, { contextInfo:{ externalAdReply: {title: ''  + saludo + '' + nombre, fake, body: dev, sourceUrl: global.channel, thumbnailUrl: ImgAll.getRandom() }}})
