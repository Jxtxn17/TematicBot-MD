...
let txt1 = `❕ *𝙉𝙐𝙀𝙑𝙊 𝘼𝘿𝙈𝙄𝙉* ❕\n\n`
txt1 += `⚠️ *• 𝙉𝙤𝙢𝙗𝙧𝙚:* @${m.messageStubParameters[0].split`@`[0]}\n`
txt1 += `⚠️ *• 𝙇𝙚 𝙤𝙩𝙤𝙧𝙜𝙤 𝙖𝙙𝙢𝙞𝙣:* @${m.sender.split`@`[0]}`
await delay(3000 * 3)
...
let txt2 = `❗ *𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝙈𝙀𝙉𝙊𝙎* ❗\n\n`
txt2 += `⚠️ *• 𝙉𝙤𝙢𝙗𝙧𝙚:* @${m.messageStubParameters[0].split`@`[0]}\n`
txt2 += `⚠️ *• 𝙇𝙚 𝙦𝙪𝙞𝙩𝙤́ 𝙖𝙙𝙢𝙞𝙣:* @${m.sender.split`@`[0]}`
await delay(3000 * 3)
