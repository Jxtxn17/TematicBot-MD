...
try {    
  ...
  for (let i = 0; i < groups.length; i++) {
    ...
    *◉ 𝙸𝙳:* ${jid}
    *◉ 𝙰𝙳𝙼𝙸𝙽:* ${isBotAdmin ? '✔ Sí' : '❌ No'}
    *◉ 𝙴𝚂𝚃𝙰𝙳𝙾:* ${participantStatus}
    *◉ 𝚃𝙾𝚃𝙰𝙻 𝙳𝙴 𝙼𝙸𝙴𝙼𝙱𝚁𝙾𝚂:* ${totalParticipants}
    *◉ 𝙴𝙽𝙻𝙰𝙲𝙴:* ${isBotAdmin ? `https://chat.whatsapp.com/${await conn.groupInviteCode(jid) || '❗ 𝙴𝚁𝚁𝙾𝚁'}` : '◉ 𝙽𝙾 𝚂𝙾𝚈 𝙰𝙳𝙼𝙸𝙽'}\n\n`;
  }
...
${txt}`, m, fake, )
  ...
  for (let i = 0; i < groups.length; i++) {
    ...
    *◉ 𝙽𝙾𝙼𝙱𝚁𝙴:* ${await conn.getName(jid)}
    *◉ 𝙸𝙳:* ${jid}
    *◉ 𝙰𝙳𝙼𝙸𝙽:* ${isBotAdmin ? '✔ 𝚂𝙸' : '❌ 𝙽𝙾'}
    *◉ 𝙴𝚂𝚃𝙰𝙳𝙾:* ${participantStatus}
    *◉ 𝚃𝙾𝚃𝙰𝙻 𝙳𝙴 𝙼𝙸𝙴𝙼𝙱𝚁𝙾𝚂:* ${totalParticipants}
    *◉ 𝙴𝙽𝙻𝙰𝙲𝙴:* ${isBotAdmin ? '❗ 𝙴𝚁𝚁𝙾𝚁' : '◉ 𝙽𝙾 𝚂𝙾𝚈 𝙰𝙳𝙼𝙸𝙽'}\n\n`;
  }
