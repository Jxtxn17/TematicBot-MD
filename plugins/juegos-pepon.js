let handler = async(m, { conn, command, text }) => {
  ...
  if (!text) return m.reply(`[❗]¡𝗖𝘂𝗮𝗹 𝗲𝘀 𝗲𝗹 𝗠𝗼𝘁𝗶𝘃𝗼 𝗽𝗮𝗿𝗮 𝗹𝗮 𝗿𝗲𝘂𝗻𝗶𝗼𝗻 𝗱𝗲𝗹 𝘀𝘁𝗮𝗳𝗳!`)
    ...
    let texto = `[🍧] 𝗘𝗹 𝗼𝘄𝗻𝗲𝗿 @${m.sender.split`@`[0]} 𝗔 𝗦𝗼𝗹𝗶𝗰𝗶𝘁𝗮𝗱𝗼 𝗹𝗮 𝗽𝗿𝗲𝘀𝗲𝗻𝗰𝗶𝗮 𝗱𝗲𝗹 𝗦𝘁𝗮𝗳𝗳 𝗽𝗼𝗿 𝗲𝗹 𝗺𝗼𝘁𝗶𝘃𝗼: ${texto} 𝗗𝗶𝗿𝗶𝗴𝗲𝘁𝗲 𝗮𝗹 𝗴𝗿𝘂𝗽𝗼 𝗱𝗲𝗹 𝗦𝘁𝗮𝗳𝗳

𝙎𝘁𝗮𝗳𝗳 𝘽𝙖𝙞𝙡𝙚𝙮𝘽𝙤𝙩-𝙈𝘿`
m.reply('[🍨]𝗣𝗲𝗿𝗳𝗲𝗰𝘁𝗼, 𝘀𝗲 𝗲𝘀𝘁𝗮 𝗲𝗻𝘃𝗶𝗮𝗻𝗱𝗼 𝗲𝗹 𝗺𝗲𝗻𝘀𝗮𝗷𝗲 𝗮 𝗹𝗼𝘀 𝗼𝘄𝗻𝗲𝗿𝘀(𝗦𝘁𝗮𝗳𝗳) 𝗱𝗲 𝘽𝙖𝙞𝙡𝙚𝙮𝘽𝙤𝙩-𝙈𝘿')
