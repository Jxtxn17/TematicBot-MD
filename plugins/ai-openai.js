...
if (!text) return conn.reply(m.chat, `*Y el texto? 🤔 Ingrese los que quiere buscar con el ChatGpt (IA)*\n❏ Ej: ${usedPrefix + command} Recomienda un top 10 de películas de acción`, m, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title:  body: '𝐒𝐮𝐩𝐞𝐫 𝐁𝐨𝐭 𝐃𝐞 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩', previewType: 0, thumbnail: imagen4, sourceUrl: redes.getRandom()}}})
try {
