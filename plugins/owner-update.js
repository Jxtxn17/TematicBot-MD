...
if (messager.includes('Already up to date.')) messager = '🚫 𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫 *ᥒ᥆ һᥲᥡ ᥲᥴ𝗍ᥙᥲᥣіzᥲᥴі᥆ᥒᥱs ⍴ᥱᥒძіᥱᥒ𝗍ᥱs*'
if (messager.includes('Updating')) messager = '🚫 𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫 *ᥲᥴ𝗍ᥙᥲᥣіzᥲᥴі᥆́ᥒ 𝖿іᥒᥲᥣіzᥲძᥲ ᥱ᥊і𝗍᥆sᥲmᥱᥒ𝗍ᥱ*\n\n' + stdout.toString()
