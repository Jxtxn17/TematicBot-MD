...
if (messager.includes('Already up to date.')) messager = '🚫 𝐀𝐓𝐄𝐍𝐂𝐈𝐎𝐍 🚫 *ᥒ᥆ һᥲᥡ ᥒᥲძᥲ 𝗊ᥙᥱ actualizar.*'
if (messager.includes('Updating')) messager = '🚫 𝐀𝐓𝐄𝐍𝐂𝐈𝐎𝐍 🚫 *ᑲᥲіᥣᥱᥡ ᥲᥴ𝗍ᥙᥲᥣіzᥲძ᥆ ᥴ᥆rrᥱᥴ𝗍ᥲmᥱᥒ𝗍ᥱ.*\n\n' + stdout.toString()
