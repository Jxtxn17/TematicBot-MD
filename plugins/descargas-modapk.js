import { search, download } from 'aptoide-scraper' 
 ...
 if (!text) return conn.reply(m.chat, '🚫 𝐄𝐑𝐑𝐎𝐑 🚫 *іᥒgrᥱsᥱ ᥱᥣ ᥒ᥆mᑲrᥱ ძᥱᥣ ᥲ⍴k 𝗊ᥙᥱ ᥱs𝗍ᥲ ᑲᥙsᥴᥲᥒძ᥆.*', m, fake, ) 
 ...
 return await conn.reply(m.chat, '🚫 𝐄𝐑𝐑𝐎𝐑 🚫 *ᥱᥣ ᥲrᥴһі᥎᥆ ᥱs ძᥱmᥲsіᥲძ᥆ ⍴ᥱsᥲძ᥆*', m, fake, ) 
 } 
