import translate from '@vitalets/google-translate-api' 
 ...
 import { es, en, id, ar, pt } from '../storage/logos/Menu1.js' 
 ...
 await conn.sendButton(m.chat, lenguajeGB['smsAvisoEG']() + idioma.text + '\n' + 'დ ```Español```', wm, null, [[`𝗠𝗘𝗡𝗨`, `${usedPrefix}menu`]], fkontak, m) 
  
 }else if (args[0] == 'en'){ 
 global.lenguajeGB = en 
 await conn.sendButton(m.chat, lenguajeGB['smsAvisoEG']() + idioma.text + '\n' + 'დ ```English```', wm, null, [[`𝗠𝗘𝗡𝗨`, `${usedPrefix}menu`]], fkontak, m) 
  
 }else if (args[0] == 'id'){ 
 global.lenguajeGB = id 
 await conn.sendButton(m.chat, lenguajeGB['smsAvisoEG']() + idioma.text + '\n' + 'დ ```Bahasa Indonesia```', wm, null, [[`𝗠𝗘𝗡𝗨`, `${usedPrefix}menu`]], fkontak, m) 
  
 }else if (args[0] == 'ar'){ 
 global.lenguajeGB = ar 
 await conn.sendButton(m.chat, lenguajeGB['smsAvisoEG']() + idioma.text + '\n' + 'დ ```عرب```', wm, null, [[`𝗠𝗘𝗡𝗨`, `${usedPrefix}menu`]], fkontak, m) 
  
 }else if (args[0] == 'pt'){ 
 global.lenguajeGB = pt 
 await conn.sendButton(m.chat, lenguajeGB['smsAvisoEG']() + idioma.text + '\n' + 'დ ```Português```', wm, null, [[`𝗠𝗘𝗡𝗨`, `${usedPrefix}menu`]], fkontak, m) 
 }else{ 
